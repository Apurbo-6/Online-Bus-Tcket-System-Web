            ...
            <div  class="container-fluid">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="username" value="<?php if(isset($_COOKIE["username"])) { echo $_COOKIE["username"]; } ?>" id="userName" onkeyup="userVal()" class="form-control"><br><br>
                        <span class="error" id="usernameErr">*<?php echo $usernameErr;?></span><br>
                    </div>
                    
                    <div class="form-group">
                    <span style="color:white">Password</span>
                    <input type="text" name="password" value="<?php if(isset($_COOKIE["password"])) { echo $_COOKIE["password"]; } ?>" id="password" onkeyup="passVal()" class="form-control">
                    </div>
